...
try {
  console.log( 'members: %o', Array.from( guild.members.keys() ) );
  console.log( 'cache: %o', Array.from( guild.members.cache.keys() ) );
...
} catch ( errGuildDB ) { console.error( 'errGuildDB: %o', errGuildDB.stack ); }
};