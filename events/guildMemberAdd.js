...
/* TRON */console.log( 'chanDefaultLog: %o', chanDefaultLog.constructor.name + ':' + ( chanDefaultLog.constructor.name === 'Channel' ? chanDefaultLog.name : chanDefaultLog.displayName );/* TROFF */
  const chanErrorLog = ( !doLog ? null : member.guild.channels.cache.get( guildConfig.Logs.Error ) );
/* TRON */console.log( 'chanErrorLog: %o', chanErrorLog.constructor.name + ':' + ( chanErrorLog.constructor.name === 'Channel' ? chanErrorLog.name : chanErrorLog.displayName );/* TROFF */
...
/* TRON */console.log( 'welcomeChan: %o', welcomeChan.constructor.name + ':' + ( welcomeChan.constructor.name === 'Channel' ? welcomeChan.name : welcomeChan.displayName );/* TROFF */
